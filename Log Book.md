...
Initial brainstorming was done on interview registration systems.
...
Different project ideas were discussed.

Problems in manual interview registration were analyzed.

Final topic selected:
Registration Form for Employee Interview.
...
Functional requirements such as candidate registration were identified.

Non-functional requirements like security and usability were listed.
...
Frontend, backend, and database interaction was planned.
...
Frontend registration form was developed.

Database tables were designed.

Guide Interaction:
UI improvement suggestions were given.
...
Backend logic for form submission was implemented.

Form validations were added.
...
Advanced validations were added.

Admin view for registered candidates was implemented.

Guide Interaction:
Security suggestions were provided.
...
Final modules were completed.

UI and performance optimization was done.
...
Unit and integration testing were performed.
